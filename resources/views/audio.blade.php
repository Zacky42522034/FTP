...
<head>
    ...
    <title>Audio - Sistem Manajemen File</title>
...
<body class="bg-gray-50">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <nav class="flex-1 overflow-y-auto px-3 pb-20 space-y-1">
                ...
                <a href="/audio"
                    ...
                    <i class="fas fa-music w-5 mr-3 text-blue-500"></i>
                    <span>Audio</span>
                    <span
    ...
    <div class="main-content">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="flex justify-between items-center px-6 py-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Audio</h1>
                    <p class="text-gray-600">Kelola semua file audio Anda</p>
                </div>
        ...
        <main class="p-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800" id="totalAudiosCount">0</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800" id="mp3Count">0</h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800">Semua Audio</h3>
                        <p class="text-gray-600 mt-1">Kelola koleksi audio Anda</p>
                    </div>
                    <div class="flex space-x-2">
                        <!-- View Toggle -->
                        ...
                        <!-- Search -->
                        <div class="relative">
                            <input type="text" id="searchInput" placeholder="Cari audio..."
                ...
                <div class="p-6">
                    ...
                    <div id="gridView" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <!-- Audio cards will be dynamically added here -->
                    </div>
                        ...
                        <div class="overflow-x-auto rounded-xl border border-gray-200">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody id="fileTableBody" class="bg-white divide-y divide-gray-200">
                                    <!-- Audio rows will be dynamically added here -->
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div id="emptyState" class="text-center py-12 hidden">
                        <i class="fas fa-music text-5xl text-gray-300 mb-4"></i>
                        <h3 class="text-lg font-medium text-gray-700 mb-2">Belum ada audio</h3>
                        <p class="text-gray-500 mb-6">Upload audio pertama Anda untuk memulai</p>
                    </div>
    ...
    <div id="audioModal"
        ...
        <div class="relative max-w-2xl max-h-full mx-4 w-full">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-6">
                <div class="text-center mb-6">
                    ...
                    <h3 id="audioName" class="text-xl font-bold text-gray-800 mb-2"></h3>
                    <p id="audioInfo" class="text-gray-600"></p>
                </div>
    ...
    <script>
        ...
        async function fetchAudios() {
            try {
                ...
                Swal.fire({
                    title: 'Error',
                    text: 'Gagal memuat data audio. Silakan refresh halaman.',
                    icon: 'error',
        ...
        function showLoading() {
            ...
            if (gridView) {
                ...
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="mt-4 text-gray-500 text-lg">Memuat audio...</p>
                </div>
            `;
            }
        }
        ...
        function hideLoading() {
            // Loading akan diganti dengan konten saat renderAudios() dipanggil
        }

        // Update audio statistics
        function updateAudioStats() {
            const totalAudios = filteredAudios.length;
            const mp3Count = filteredAudios.filter(audio => {
                const ext = audio.name?.split('.').pop()?.toLowerCase();
                return ext === 'mp3';
            }).length;

            const totalSize = filteredAudios.reduce((total, audio) => {
                return total + parseSizeToBytes(audio.size || '0');
            }, 0);

            const averageSize = totalAudios > 0 ? totalSize / totalAudios : 0;
            ...
            updateIfExists('totalAudiosCount', totalAudios);
            updateIfExists('mp3Count', mp3Count);
        ...
        function renderAudios() {
            ...
            const endIndex = Math.min(startIndex + itemsPerPage, filteredAudios.length);
            ...
            paginatedAudios.forEach((audio, index) => {
                ...
                const uploadDate = audio.date
                    ? audio.date
                    : (audio.created_at ? new Date(audio.created_at).toLocaleDateString('id-ID', {
                        day: '2-digit',
                        month: 'short',
                        year: 'numeric'
                    }) : 'Tidak diketahui');
                ...
                audioCard.className = 'file-card bg-white rounded-xl p-4 cursor-pointer hover:shadow-lg transition';
                audioCard.dataset.type = ext;
                    ...
                    <div class="relative dropdown">
                        ...
                        <div class="dropdown-content bg-white rounded-xl shadow-lg border border-gray-200 py-2 w-48 hidden absolute right-0 z-10">
                            <a href="javascript:void(0);" 
                                onclick="event.preventDefault(); playAudio('${audio.name}')" 
                            ...
                            <a href="/storage/uploads/${encodeURIComponent(audio.name)}"
                            ...
                            <a href="javascript:void(0);" 
                                onclick="event.preventDefault(); confirmDelete('${encodeURIComponent(audio.name)}')" 
                ...
                <!-- Audio Preview -->
                <div class="audio-preview ${config.previewColor} mb-3" 
                     onclick="event.preventDefault(); playAudio('${audio.name}')">
                    ...
                    <div class="audio-duration duration-cell">
                        ${formatDurationShort(audio.duration || 0)}
                    </div>
                </div>
                
                <h4 class="font-semibold text-gray-800 mb-2 truncate" title="${audio.name}">
                    ${audio.name}
                </h4>
            ...
            `;
                ...
                gridView.appendChild(audioCard);

                // Ambil durasi audio
                getAudioDuration(`/storage/uploads/${audio.name}`, dur => {
                    const durationCell = audioCard.querySelector('.duration-cell');
                    if (durationCell) {
                        durationCell.textContent = formatDurationShort(dur);
                    }
                });

                setupFavoriteButton(audioCard, audio);
            });
            ...
            paginatedAudios.forEach((audio, index) => {
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        ...
                        <div class="text-sm font-medium text-gray-900 truncate max-w-xs" title="${audio.name}">
                            ${audio.name}
                        </div>
                    </div>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div class="flex justify-end space-x-2">
                        <button onclick="event.preventDefault(); playAudio('${audio.name}')" 
                        ...
                        <a href="/storage/uploads/${encodeURIComponent(audio.name)}" download
            ...
            `;
                ...
                // Ambil durasi audio untuk list view
                getAudioDuration(`/storage/uploads/${audio.name}`, dur => {
                    const durationCell = tableRow.querySelector('.duration-cell');
                    if (durationCell) {
                        durationCell.textContent = formatDuration(dur);
                    }
                });
            });
        ...
        function updatePaginationInfo() {
            ...
            startItem.textContent = filteredAudios.length > 0 ? startIndex + 1 : 0;
            endItem.textContent = endIndex;
            totalItems.textContent = filteredAudios.length;
        }

        function getAudioDuration(fileUrl, callback) {
        ...
        function setupPagination() {
            ...
            console.log(`📄 Pagination: Page ${currentPage} of ${totalPages}, Total items: ${filteredAudios.length}`);
        }
        ...
        function playAudio(filename) {
            ...
            modalAudio.src = `/storage/uploads/${encodeURIComponent(filename)}`;
            audioName.textContent = filename;

            // Find audio file info
            const audioFile = audios.find(a => a.name === filename);
            if (audioFile) {
                const ext = filename.split('.').pop()?.toLowerCase();
                const config = fileConfig[ext] || fileConfig.default;
                audioInfo.textContent = `${config.type} • ${audioFile.size || '-'}`;
            }

            downloadAudio.onclick = () => {
                window.location.href = `/storage/uploads/${encodeURIComponent(filename)}`;
            };
        ...
        // Close audio player
        document.getElementById('closeAudioModal').addEventListener('click', (e) => {
            e.preventDefault();
            const modal = document.getElementById('audioModal');
            const modalAudio = document.getElementById('modalAudio');
        ...
        document.getElementById('closeAudioModalBtn').addEventListener('click', (e) => {
            e.preventDefault();
            const modal = document.getElementById('audioModal');
            const modalAudio = document.getElementById('modalAudio');
        ...
        function setupFavoriteButton(element, audio) {
            ...
            const localKey = `favorite_${audio.name}`;
            let isFavorite = localStorage.getItem(localKey);

            if (isFavorite === null) {
                isFavorite = audio.favorite === '1' || audio.favorite === 1 ? '1' : '0';
        ...
        function confirmDelete(filename) {
            Swal.fire({
                ...
                text: "Audio ini akan dihapus secara permanen!",
                icon: 'warning',
        ...
        function showFileDetails(index) {
            ...
            const audio = filteredAudios[index];
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <h4 class="text-xl font-bold text-gray-800 mb-2 break-words">${audio.name}</h4>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            <p class="text-sm text-gray-500">Tipe Audio</p>
                        ...
                        <div>
                            ...
                            <p class="font-medium">${audio.size || '-'}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Durasi</p>
                            <p class="font-medium">${formatDuration(audio.duration || 0)}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Tanggal Upload</p>
                            <p class="font-medium">${audio.date || 'Tidak diketahui'}</p>
                        </div>
                    </div>
        ...
        function initializeApp() {
            console.log('🚀 Initializing audio player app...');
