                        ...
                        <div class="relative dropdown">
                            ...
                            <div class="dropdown-content bg-white rounded-xl shadow-lg border border-gray-200 py-2 w-48 hidden absolute right-0 z-10">
                                <a href="javascript:void(0);" 
                                    onclick="showFileDetails('${doc.name}')" 
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-info-circle mr-2"></i> Detail
                                </a>
                                <a onclick="event.stopPropagation()" href="/storage/uploads/${encodeURIComponent(doc.name)}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                    download>
                                    <i class="fas fa-download mr-2"></i> Unduh
                                </a>
                                <a href="javascript:void(0);" 
                                    onclick="event.stopPropagation(); openShareModal('${doc.name}')" 
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-share-alt mr-2"></i> Bagikan
                                </a>
                                <a href="javascript:void(0);" 
                                    onclick="event.stopPropagation(); confirmDelete('${encodeURIComponent(doc.name)}')" 
                ...
                row.innerHTML = `
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end space-x-2">
                            ...
                            <button onclick="event.stopPropagation(); openShareModal('${doc.name}')" class="text-purple-600 hover:text-purple-900 p-1 rounded">
